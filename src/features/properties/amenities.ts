...
export function getSuggestedAmenitiesForProperty(propertyType?: PropertyType | null): AmenityDefinition[] {
  ...
  const typeOverrides: Record<PropertyType, string[]> = {
    ...
    independent_house: ['parking', 'garden', 'balcony', 'power_backup', 'water_supply', 'terrace'],
    ...
    co_living: ['wifi', 'food', 'washing_machine', 'housekeeping', 'common_area', 'ac'],
    independent_floor: ['parking', 'balcony', 'water_supply', 'power_backup', 'terrace'],
    builder_floor: ['parking', 'balcony', 'water_supply', 'power_backup', 'terrace'],
    room: ['wifi', 'ac', 'fan', 'water_supply', 'geyser'],
    bed_space: ['food', 'laundry', 'wifi', 'cctv', 'washing_machine', 'housekeeping'],
