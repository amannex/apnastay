...
export default function AuthVectorIllustration() {
  return (
    <div className="relative w-full max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1200px] aspect-square flex items-center justify-center select-none pointer-events-none">
      ...
      <motion.div
        ...
        className="absolute w-200 h-200 xl:w-350 xl:h-350 rounded-full bg-gradient-to-tr from-[#E1224D]/15 via-amber-200/20 to-transparent blur-3xl pointer-events-none"
      />
